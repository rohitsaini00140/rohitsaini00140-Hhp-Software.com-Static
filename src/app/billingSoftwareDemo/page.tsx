            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-5xl sm:leading-tight md:leading-tight">
                  Streamline Your Billing with Ease
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  Effortlessly manage your invoicing, payments, and financial tracking with our intuitive billing software. Designed for businesses of all sizes, our software automates billing processes, reduces errors, and ensures accurate, timely invoicing. Enjoy features like customizable templates, real-time analytics, and secure payment gateways, all in one user-friendly platform. Save time, increase efficiency, and focus on growing your business while we handle the numbers.
                </p>
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link
                    href="https://www.hhpbilling.com/"
                    target="_blank"
...
export default BillingSoftwareDemo;