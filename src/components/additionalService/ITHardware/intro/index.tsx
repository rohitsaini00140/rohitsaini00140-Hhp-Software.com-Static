...
function Intro() {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white-300 pb-10 pt-[120px] dark:bg-gray-dark md:pb-[10px] md:pt-[150px] xl:pb-[80px] xl:pt-[180px] 2xl:pb-[150px] 2xl:pt-[210px]"
      >
